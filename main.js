...
function update()
{
    ...
    var updatedImage = ["https://img.favpng.com/4/24/8/clip-art-mother-openclipart-illustration-image-png-favpng-iaCpPK5ewsh00VYqUkfRFfaif.jpg"];
    //Debug the code to store list of names in updatedName. Use names[i]
    var updatedName = ["shalini"];
